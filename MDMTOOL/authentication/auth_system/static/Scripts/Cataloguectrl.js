(function() {
    ...
    app.controller('CatalogueController', function($scope, $http, $timeout, $window, $filter, $location, $rootScope) {
        ...
        $scope.getbincode = function() {
            ...
            $http.get('/Master/getbincode?label= Storage bin' + '&StorageLocation=' + $scope.cat.StorageLocation1).success(function(response) {
        ...
        $scope.loadmodifier = function(noun) {
            ...
            $scope.Characteristics = null;
            $scope.cat.RevRemarks = null;
            $scope.cat.RelRemarks = null;
            $scope.cat.EnrichedValue = null;
        ...
        $scope.getSubcode = function() {
            ...
            $http.get('/GeneralSettings/GetSubGroupcodeList1', { params: { MainGroupCode: $scope.cat.Maincode } }).success(function(response) {
        ...
        $scope.getSubsubcode = function() {
            ...
            $http.get('/GeneralSettings/GetSubsubGroupcodeList', { params: { SubGroupCode: $scope.cat.Subcode } }).success(function(response) {
